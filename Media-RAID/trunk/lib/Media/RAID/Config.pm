...
Media::RAID::Config - The great new Media::RAID::Config!
...
Perhaps a little code snippet.
    ...
    use Media::RAID::Config;

    my $foo = Media::RAID::Config->new();
    ...
