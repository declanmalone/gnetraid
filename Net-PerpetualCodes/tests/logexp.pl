...
my $log_size = @log_table;
my $exp_size = @exp_table;

say "Log table has $log_size elements";
say "Exp table has $exp_size elements";

my $fn = "gf8_log_exp.c";
open my $fh, ">", $fn or die "Problem creating output $fn: $!\n";

print $fh "/* Compact Log/Exp tables for calculations over GF(2**8) */\n\n";
print $fh "/* Uses switch statements for embedded device */\n\n";

print $fh  "unsigned char gf8_log (unsigned char a) {\n";
print $fh  "  switch (a) {\n";
print $fh  "    case $_: a=$log_table[$_]; break;\n" for (0..255);
print $fh  "  };\n";
print $fh  "  return a;\n";
print $fh  "}\n\n";

print $fh  "unsigned char gf8_exp (unsigned char a) {\n";
print $fh  "  switch (a) {\n";
print $fh  "    case $_: a=$exp_table[$_]; break;\n" for (0..255);
print $fh  "  };\n";
print $fh  "  return a;\n";
print $fh  "}\n\n";
