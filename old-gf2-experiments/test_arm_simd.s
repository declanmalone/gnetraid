...
@ my new routine
	.global	gf2_test_arm_simd
	.type	gf2_test_arm_simd, %function
gf2_test_arm_simd:
	@ args = 0, pretend = 0, frame = 0
	@ frame_needed = 0, uses_anonymous_args = 0
	@ link register save eliminated.
	...
	@ test uadd8 and sel; we should take a 4vec and return 0xff
	@ for each sum that overflows
	...
	bx	lr
	.size	gf2_test_arm_simd, .-gf2_test_arm_simd
	.align	2
@ end of my new routine
