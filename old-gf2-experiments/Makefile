# This Makefile is for the Crypto::mylib extension to perl.
#
...
XS_FILES = 
C_FILES  = arm_as_test.c \
	dump_min_tables.c \
	fast_gf2.c \
	minimal_tables.c \
	rabin-ida.c \
	test_arm_simd_fast_gf2.c \
	test_arm_simd_main.c \
	test_fast_gf2.c \
	test_overflow.c \
	test_wrappers.c
O_FILES  = arm_as_test.o \
	dump_min_tables.o \
	fast_gf2.o \
	minimal_tables.o \
	rabin-ida.o \
	test_arm_simd_fast_gf2.o \
	test_arm_simd_main.o \
	test_fast_gf2.o \
	test_overflow.o \
	test_wrappers.o
H_FILES  = fast-gf2-wrapper-albatross.h \
	fast_gf2.h \
	fast_gf2_wrappers-albatross.h \
	rabin-ida.h
MAN1PODS = 
MAN3PODS = 
...
INST_LIBDIR      = $(INST_LIB)/Crypto
INST_ARCHLIBDIR  = $(INST_ARCHLIB)/Crypto
...
TO_INST_PM = fast_gf2_method_chooser.pl \
	rabin-ida-inlinec.pl

PM_TO_BLIB = rabin-ida-inlinec.pl \
	$(INST_LIB)/Crypto/rabin-ida-inlinec.pl \
	fast_gf2_method_chooser.pl \
	$(INST_LIB)/Crypto/fast_gf2_method_chooser.pl
...
DISTNAME = Crypto-mylib
DISTVNAME = Crypto-mylib-
...
# Crypto::mylib might depend on some other libraries:
...
metafile : create_distdir
	...
	$(NOECHO) $(ECHO) 'name:               Crypto-mylib' >> META_new.yml
...
pm_to_blib : $(FIRST_MAKEFILE) $(TO_INST_PM)
	$(NOECHO) $(ABSPERLRUN) -MExtUtils::Install -e 'pm_to_blib({@ARGV}, '\''$(INST_LIB)/auto'\'', q[$(PM_FILTER)], '\''$(PERM_DIR)'\'')' -- \
	  rabin-ida-inlinec.pl $(INST_LIB)/Crypto/rabin-ida-inlinec.pl \
	  fast_gf2_method_chooser.pl $(INST_LIB)/Crypto/fast_gf2_method_chooser.pl 
...
# AR => q[ar]
# ARGS => { NAME=>q[Crypto::mylib], SKIP=>[q[all], q[static], q[static_lib], q[dynamic], q[dynamic_lib]], clean=>{ FILES=>q[libmylib$(LIB_EXT)] } }
# AR_STATIC_ARGS => q[cr]
# BASEEXT => q[mylib]
# BOOTDEP => q[]
# BUILD_REQUIRES => {  }
# C => [q[arm_as_test.c], q[dump_min_tables.c], q[fast_gf2.c], q[minimal_tables.c], q[rabin-ida.c], q[test_arm_simd_fast_gf2.c], q[test_arm_simd_main.c], q[test_fast_gf2.c], q[test_overflow.c], q[test_wrappers.c]]
# CC => q[cc]
# CCCDLFLAGS => q[-fPIC]
# CCDLFLAGS => q[-Wl,-E]
# CCFLAGS => q[-D_REENTRANT -D_GNU_SOURCE -DDEBIAN -fstack-protector -fno-strict-aliasing -pipe -I/usr/local/include -D_LARGEFILE_SOURCE -D_FILE_OFFSET_BITS=64]
# CFLAGS => q[ CCFLAGS = -D_REENTRANT -D_GNU_SOURCE -DDEBIAN -fstack-protector -fno-strict-aliasing -pipe -I/usr/local/include -D_LARGEFILE_SOURCE -D_FILE_OFFSET_BITS=64 OPTIMIZE = -O2 -g PERLTYPE =  MPOLLUTE =  ]
# CHMOD => q[chmod]
# CI => q[ci -u]
...
# DIR => []
# DIRFILESEP => q[/]
# DISTNAME => q[Crypto-mylib]
# DISTVNAME => q[Crypto-mylib-]
# DIST_CP => q[best]
...
# MAKEMAKER => q[/usr/share/perl/5.14/ExtUtils/MakeMaker.pm]
...
# OSNAME => q[linux]
# OSVERS => q[3.0.90]
# O_FILES => [q[arm_as_test.o], q[dump_min_tables.o], q[fast_gf2.o], q[minimal_tables.o], q[rabin-ida.o], q[test_arm_simd_fast_gf2.o], q[test_arm_simd_main.o], q[test_fast_gf2.o], q[test_overflow.o], q[test_wrappers.o]]
# PARENT_NAME => q[Crypto]
# PERL => q[/usr/bin/perl]
# PERLMAINCC => q[$(CC)]
# PERLPREFIX => q[$(PREFIX)]
# PERLRUN => q[$(PERL)]
...
# PERL_ARCHLIB => q[/usr/lib/perl/5.14]
# PERL_CORE => q[0]
# PERL_INC => q[/usr/lib/perl/5.14/CORE]
# PERL_LIB => q[/usr/share/perl/5.14]
...
# PERM_RWX => q[755]
# PL_FILES => {  }
# PM => { rabin-ida-inlinec.pl=>q[$(INST_LIB)/Crypto/rabin-ida-inlinec.pl], fast_gf2_method_chooser.pl=>q[$(INST_LIB)/Crypto/fast_gf2_method_chooser.pl] }
# PMLIBDIRS => []
...
# SHAR => q[shar]
# SHELL => q[/bin/sh]
# SITEARCHEXP => q[/usr/local/lib/perl/5.14.2]
# SITELIBEXP => q[/usr/local/share/perl/5.14.2]
# SITEPREFIX => q[$(PREFIX)/local]
# SKIPHASH => { static_lib=>q[1], dynamic=>q[1], dynamic_lib=>q[1], static=>q[1], all=>q[1] }
# SO => q[so]
# SUFFIX => q[.gz]
# TAR => q[tar]
# TARFLAGS => q[cvf]
