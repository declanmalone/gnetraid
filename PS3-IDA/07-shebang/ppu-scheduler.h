...
// scheduler thread. Instead of other threads modifying global state
// variables directly, they send an appropriate message to the
// scheduler through its event queue. The scheduler then updates the
// global state on the caller's behalf
...
// names for these events are defined in ppu-scheduler.c
